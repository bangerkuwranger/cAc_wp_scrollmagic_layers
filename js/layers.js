...
jQuery(function($) {
	...
	$('.cAc_wpsml-pageSection').each( function() {
		...
		scenes[thisId + "bg"] = new ScrollMagic.Scene({triggerElement: "#" + thisId + " .cAc_wpsml-bg", duration: 2000, offset: 0})
		...
		scenes[thisId + "content"] = new ScrollMagic.Scene({triggerElement: "#" + thisId + " .cAc_wpsml-content", duration: 768, offset: -760})
						...
						.addTo(controller);
		scenes[thisId + "media"] = new ScrollMagic.Scene({triggerElement: "#" + thisId + " .cAc_wpsml-media", duration: 200, offset: -200})
						// .setTween(tweens[thisId])
